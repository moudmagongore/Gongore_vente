            ...
            children: [
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'Ex. Loyer, Électricité, Transport',
                ),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'À quoi correspond ce poste de dépense ?',
                ),
              ...
              Obx(
                () => SwitchListTile.adaptive(
                  ...
                  title: const Text('Proposée à la saisie'),
                  subtitle: Text(
                    controller.active.value
                        ? 'Les gestionnaires peuvent déclarer une dépense sur cette nature.'
                        : 'Masquée du formulaire de dépense. L\'historique reste intact.',
                    style: TextStyle(
                      fontSize: 11.5,
              ...
              Obx(
                () => ElevatedButton.icon(
                  ...
                  label: Text(
                    controller.isEdit ? 'Enregistrer' : 'Créer la nature',
                  ),
                ),
              ),
              const SizedBox(height: 8),
              OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side:
                      BorderSide(color: AppColors.primary(context), width: 1.4),
